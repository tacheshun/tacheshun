...
✅ Tech I used in production environment: Go(golang), Java, PHP, Python, PostgreSQL, MySQL, Cassandra, Redis, Elasticsearch, Prometheus, Grafana, Docker, Kubernetes, CloudFoundry, RabbitMQ, REST, gRPC, Google Cloud Platform, Microsoft Azure.
