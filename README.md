...
🚀 I'm a skilled backend engineer specializing in building scalable websites and APIs. I like Go programming language, but I also have some experience with Python, PHP, and Java. I have experience with relational databases (PostgreSQL, MySQL), some NoSQL databases(Redis, Clickhouse) container technology (Docker, Kubernetes), messaging systems (Kafka, RabbitMQ), and major cloud providers (AWS, GCP, Azure).  
